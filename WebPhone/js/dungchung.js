...
function addHeader() {
  document.write(`        
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/SJNLOGO.PNG" alt="Trang chủ Smartphone Store" title="Trang chủ Smartphone Store">
            </a>
        </div> <!-- End Logo -->
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">TRONG TIN Store</a> - All rights reserved © 2022 - Designed by
            <span style="color: #eee; font-weight: bold">hoangson</span></p>
    </div>`);
}
